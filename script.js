...
const i18n = {
  ar: {
    ...
    shareBtn:         "مشاركة",
    footerCopy:       "الموقع مفتوح المصدر في GitHub",
    cardCta:          "اقرأ الملخص",
    bookBadge:        "ملخص كتاب",
    audioLabel:       "استمع إلى الملخص",
    summaryLabel:     "الملخص القصير ( لايغني عن قراءة الكتاب)",
  ...
  en: {
    ...
    shareBtn:         "Share",
    footerCopy:       "The site is open source on GitHub",
    cardCta:          "Read Summary",
    bookBadge:        "Book Summary",
    audioLabel:       "Listen to Summary",
    summaryLabel:     "Short summary (does not replace reading the book)",
